            ...
            <div class="container">
                <div class="card mx-auto mt-5">
                    <div class="card-header">
                        <h4><i class="fa fa-fw fa-shopping-cart"></i> Purchase Order Reports</h4></div>
                    <div class="card-body">
                            ...
                            <div class="col-xl-4 col-sm-6 mb-3">
                                <div class="card text-white bg-success o-hidden h-100">
                                    <div class="card-body">
                                        ...
                                        <div class="mr-5"><?php echo number_format($_SESSION['complete_purchase']); ?> Complete Orders!</div>
                                    </div>
                                    <a class="card-footer text-white clearfix small z-1" href="./complete-orders.php">
                            ...
                            <div class="col-xl-4 col-sm-6 mb-3">
                                <div class="card text-white bg-primary o-hidden h-100">
                                    <div class="card-body">
                                        ...
                                        <div class="mr-5"><?php echo number_format($_SESSION['approved_purchase']); ?> Approved Orders!</div>
                                    </div>
                                    <a class="card-footer text-white clearfix small z-1" href="./approved-orders.php">
                                        <span class="float-left">View Table</span>
                                        <span class="float-right">
                                            <i class="fa fa-angle-right"></i>
                                        </span>
                        ...
                        <?php include_once './includes/purchase-orders.inc.php'; ?>
                        <!--=====================================================================-->
